...
def patch_channel_storage_verifier():
    ...
    new = 'require(PICKWORD.splitlines()[0] in ("// @version 1.0.21", "// @version 1.0.22", "// @version 1.0.23", "// @version 1.0.24", "// @version 1.0.25", "// @version 1.0.26", "// @version 1.0.27", "// @version 1.0.28", "// @version 1.0.29", "// @version 1.0.30", "// @version 1.0.31", "// @version 1.0.32", "// @version 1.0.33"), "th_20_pickword.js version must be 1.0.21, 1.0.22, 1.0.23, 1.0.24, or 1.0.25")'
    if old in text:
