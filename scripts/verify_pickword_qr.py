...
require(QR, "proto.showPickwordTextQRCode = function(text)", "text-only QR generate bridge")
require(QR, 'source: "qr_generate_text"', "text-only QR generated image source")
require(QR, 'appObj.showPickwordText("", genMeta);', "text-only QR image handoff")
...
if qr_version in ("// @version 1.0.6", "// @version 1.0.7", "// @version 1.0.8", "// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18"):
    require(QR, "new Packages.dalvik.system.DexClassLoader", "Rhino Packages DexClassLoader")
else:
    require(QR, "new Packages.dalvik.system.DexClassLoader", "legacy DexClassLoader")
...
if qr_version in ("// @version 1.0.5", "// @version 1.0.6", "// @version 1.0.7", "// @version 1.0.8", "// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18"):
...
if qr_version in ("// @version 1.0.7", "// @version 1.0.8", "// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18"):
...
if qr_version in ("// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18"):
    for token in (
...
print("OK pickword_qr stable_qr=1 system_server_dexloader=%d rhino_packages=%d diagnostics=%d load_text_reuse_window=%d" % (
    1 if qr_version in ("// @version 1.0.5", "// @version 1.0.6", "// @version 1.0.7", "// @version 1.0.8", "// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18") else 0,
    1 if qr_version in ("// @version 1.0.6", "// @version 1.0.7", "// @version 1.0.8", "// @version 1.0.9", "// @version 1.0.10", "// @version 1.0.11", "// @version 1.0.12", "// @version 1.0.13", "// @version 1.0.14", "// @version 1.0.15", "// @version 1.0.16", "// @version 1.0.17", "// @version 1.0.18") else 0,
