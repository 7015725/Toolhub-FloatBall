...
require('// @version 1.2.4' in th22, "image viewer version")
...
require('function rootExecutableCandidates22()' in th22, "Root executable candidate resolver missing")
for marker in ('/system/bin/su', '/system/xbin/su', '/debug_ramdisk/su', '/data/adb/ksu/bin/su', '/data/adb/ap/bin/su'):
    require(marker in th22, "Root executable candidate missing: " + marker)
require('args.add(executable)' in th22 and 'builder.environment().put("PATH", fixedPath)' in th22, "absolute Root executable launch missing")
require('pickword image root executable path=' in th22, "selected Root executable log missing")
require('["su", "--mount-master"' not in th22, "bare su ProcessBuilder variant must not be primary implementation")
