...
require('__toolHubPickwordImageViewerVersion = \"1.3.1\"' in th22 and '=== \"1.3.1\"' in th22, "image viewer install version guard missing")
require('// @version 1.3.1' in th22, "image viewer version")
