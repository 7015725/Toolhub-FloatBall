...
require('__toolHubPickwordImageViewerVersion = \"1.3.2\"' in th22 and '=== \"1.3.2\"' in th22, "image viewer install version guard missing")
require('// @version 1.3.2' in th22, "image viewer version")
...
require('function thumbnailCacheRoot22()' in th22 and 'ToolHub/cache/screenshot_thumbnails' in th22, "private saved thumbnail cache missing")
