...
require('// @version 1.2.9' in th22, 'th22 service version')
require('// @version 1.0.3' in th23, 'th23 version')
...
print('OK screenshot-manager saved_probe=media,stream,java,root clear=definitive_missing actions=view,share,delete,clear migration=3')
