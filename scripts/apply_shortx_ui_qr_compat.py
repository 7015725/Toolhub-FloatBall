...
def main():
    ...
    text = replace_once(text, "ENTRY_VERSION = 20260825075903", "ENTRY_VERSION = 20260825084735", "entry version")
    text = replace_once(
        text,
    ...
    validate_qr_runtime()
    print("OK ShortXUI finalizer preserves Beta QR 1.0.7..1.0.15 load-text reuse-window fix")
