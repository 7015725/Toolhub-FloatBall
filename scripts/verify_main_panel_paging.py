...
if not version or version.group(1) != "1.5.0":
    fail("expected th_15_main_panel.js version 1.5.0")
...
require(RUNTIME_VERIFY, 'version.group(1) != "1.5.0"', "runtime verifier current version")
require(DRAG_VERIFY, 'version.group(1) != "1.5.0"', "drag verifier current version")
