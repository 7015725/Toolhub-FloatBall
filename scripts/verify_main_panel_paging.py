...
if not version or version.group(1) != "1.4.1":
    fail("expected th_15_main_panel.js version 1.4.1")
...
require(RUNTIME_VERIFY, 'version.group(1) != "1.4.1"', "runtime verifier current version")
require(DRAG_VERIFY, 'version.group(1) != "1.4.1"', "drag verifier current version")
