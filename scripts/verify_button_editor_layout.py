...
def main():
    ...
    checks = [
        ...
        ("manager has simple search hint", "搜索工具" in button_text),
        ("manager search clear button wording", "清空" in button_text),
        ("manager no verbose search title", "寻找工具" not in button_text),
        ("manager no verbose clear button wording", "createButtonManagerActionChip(\"重置\"" not in button_text),
