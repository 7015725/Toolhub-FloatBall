// ToolHub Beta Phase 7B public FrameLoop + ReflectionBridge entry r1.
// Loads verified Phase 7A, then the verified public component exports and tests.
// Rhino ES5 / ShortX.
(function () {
  var ENTRY_VERSION = "0.8.1-phase7b-entry-r1";
  var SNAPSHOT = "34ec9e78eedca409d6407602a8b7ebbdaf1b84fa";
  var FILES = [
    {
  ...
  function downloadVerified(spec) {
    ...
    try {
      ...
      conn.setRequestProperty("User-Agent", "ShortX-ToolHub-Beta-Phase7B-R1");
